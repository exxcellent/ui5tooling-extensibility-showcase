sap.ui.define([
	...
	return Controller.extend("de.exxcellent.ui5tooling.projectshim.controller.App", {
		...
		onInit: function() {
			...
			var oModel = new JSONModel({
				now:  moment().format("D.MMMM YYYY"),
				future: moment().add(200, "days").format("D.MMMM YYYY")
			});
